                                   ...
                                   struct audio_stream_out **stream_out)
{
    ...
    out->buffer_size = 512 * 8 * 2; /* SS_BLUETOOTH 2012.06.13 to prevent a chopping of notification */
                                    /* In order to fix that notification sound is distorded and A2DP in music player is chopped. Jul.23.2012 by Changhyeok Han */
